...
public class EditSectionResponseDto {
    ...
    private EditSectionResponseDto(Long sectionId, String content) {
        this.sectionId = sectionId;
        this.content = content;
    }

    public static EditSectionResponseDto of(Long sectionId, String content) {
        return new EditSectionResponseDto(sectionId, content);
    }
}
